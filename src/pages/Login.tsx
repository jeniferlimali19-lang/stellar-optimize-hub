...
const Login = () => {
  ...
  const handleInstall = async () => {
    if (!installPrompt) {
      toast.info(
        "A instalação ainda não está disponível. Abra este site no Chrome e tente novamente."
      );
      return;
    }
        ...
        <div className="glass rounded-2xl p-8 glow-pink">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              />
              <path
                d="M40 16L44 28H56L46 36L50 48L40 40L30 48L34 36L24 28H36L40 16Z"
                fill="hsl(330, 90%, 56%)"
                opacity="0.9"
              />
              <circle
